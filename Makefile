...
#Sources
SRC_FILES	= cub3d calc_texture colors config controls dda draw freedom_sings game generate_map init_raycasting map_utils map_validations player printable texture validations
