...
/*   Updated: 2023/01/30 11:47:18 by jocardos         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void    vertical_player_move(int keycode, t_vars *var, float speed)
{
    ...
    {
        if (map[(int)g->pos_y][(int)(g->pos_x + g->dir_x * speed)] == DOOR_OPEN
			|| map[(int)g->pos_y][(int)(g->pos_x + g->dir_x * speed)] == FLOOR)
			g->pos_x += g->dir_x * speed;
        if (map[(int)(g->pos_y + g->dir_y * speed)][(int)g->pos_x] == DOOR_OPEN
            || map[(int)(g->pos_y + g->dir_y * speed)][(int)g->pos_x] == FLOOR)
...
void    horizontal_player_move(int keycode, t_vars *var, float speed)
{
    ...
    {
        if (map[(int)g->pos_y][(int)(g->pos_x + g->plane_x * speed)] == DOOR_OPEN
			|| map[(int)g->pos_y][(int)(g->pos_x + g->plane_x * speed)] == FLOOR)
			g->pos_x += g->plane_x * speed;
        if (map[(int)(g->pos_y + g->plane_y * speed)][(int)g->pos_x] == DOOR_OPEN
            || map[(int)(g->pos_y + g->plane_y * speed)][(int)g->pos_x] == FLOOR)
...
void    handle_keypress(int keycode, t_vars *var)
{
    ...
    // BONUS : else if (keycode == KEY_E)
    //     // TODO: Função para abrir e fechar a porta
    // else if (keycode == KEY_C)
    //     // TODO: Função para mudar do mouse para as setas e vice versa
